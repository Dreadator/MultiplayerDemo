...
public class GameEndUIManager : NetworkBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            HungryHippoGameManager.Instance.OnGameEnded += HungryHippoGameManager_OnGameEnded;
            HungryHippoGameManager.Instance.OnGameRestarted += HideEndGameScreen;
        }
    ...
    private void HandleRetryButtonpressed() =>
        HungryHippoGameManager.Instance.RestartGameServerRPC();
